...
const BuyerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden pb-20" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <StarfieldCanvas count={50} opacity={0.6} />

      {/* Ambient glow orbs — CSS only to avoid extra WebGL contexts */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] opacity-20 pointer-events-none rounded-full"
        style={{ background: 'radial-gradient(circle at 40% 40%, rgba(255,215,0,0.18) 0%, rgba(120,80,200,0.10) 40%, transparent 70%)', filter: 'blur(40px)' }} />
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] opacity-10 pointer-events-none rounded-full"
        style={{ background: 'radial-gradient(circle at 60% 60%, rgba(100,80,255,0.2) 0%, rgba(255,215,0,0.08) 50%, transparent 70%)', filter: 'blur(50px)' }} />
