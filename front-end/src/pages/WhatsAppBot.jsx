...
const WhatsAppBot = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden pb-32" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="absolute top-[-5%] right-[-8%] w-[480px] h-[480px] opacity-[0.07] pointer-events-none rounded-full"
        style={{ background: 'radial-gradient(circle at 60% 40%, rgba(37,211,102,0.15) 0%, rgba(120,80,200,0.08) 40%, transparent 70%)', filter: 'blur(50px)' }} />
